...
public class ImageSpectrumGreen extends AbstractImage implements IProcessImage {
	...
	public BufferedImage process() throws IOException {
		...
		resultImage_ = MatrixImageUtilities.spectrumToColor(resultImage_, (float) 0.25, 1, 1, (float) 0.5, 1, 1,
				Color.BLACK);
		return resultImage_;
	}
