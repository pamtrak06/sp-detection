...
public class ImageSmooth extends AbstractImage implements IProcessImage {
	...
	public BufferedImage process() throws Exception {
		...
		int[][] resultMatrix = MatrixLevelUtilities.smooth4ByteMatrix(byteMatrix, (Integer) getParameterValue(PARAM_FACTOR));
